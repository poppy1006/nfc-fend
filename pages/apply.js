      ...
      <section className={styles.background + " min-h-screen flex justify-center items-center"}>
        <div className="main">
            <div className="content bg-white border-2 px-4 py-8 rounded-2xl shadow-lg">
              <h1 className="text-2xl font-bold text-center">Get started now</h1>
              <p className='text-center'>Enter your card number and creds</p>
              <p className='text-center py-5 font-bold text-gray-500'>Start building your digital identity</p>
              <form onSubmit={handleRegister} className='flex flex-col gap-4 text-lg mt-5'>
                <span className='flex flex-row shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                  <img className='w-7 mr-3' src="/svg/num.svg" alt="" />
                  <input value={handle} onChange={e=>setHandle(e.target.value)} className='focus:outline-none' type="number" placeholder="Enter Card Number" required/>
                </span>
